...
<p align="center">
  ...
  <a href="https://github.com/biotec-line"><img src="https://img.shields.io/badge/Standards-VCF_4.2_%7C_gVCF-teal.svg?style=flat-square" alt="VCF 4.2 | gVCF"></a>
  ...
  <a href="https://github.com/biotec-line"><img src="https://img.shields.io/badge/Platform-Windows_%7C_macOS_%7C_Linux-informational.svg?style=flat-square" alt="Platform"></a>
  ...
  <a href="https://github.com/biotec-line/.github/blob/main/SECURITY.md"><img src="https://img.shields.io/badge/Security_SLA-48h_Response-critical.svg?style=flat-square" alt="Security SLA"></a>
  <a href="https://github.com/biotec-line/.github/blob/main/CHANGELOG.md"><img src="https://img.shields.io/badge/Verified-2026--09--23-blue.svg?style=flat-square" alt="Verified 2026-09-23"></a>
...
biotec-line builds practical, privacy-centric Python desktop software for working with sensitive genetic files on local machines. The current projects focus on converting direct-to-consumer (DTC) DNA exports (23andMe, MyHeritage, FamilyTreeDNA, TellMeGen, etc.) into standard VCF 4.2, validating genome builds (GRCh37/GRCh38), annotating VCF/gVCF data with gnomAD and ClinVar fields, filtering variants, and exporting research-oriented reports without routing genomic data into third-party cloud infrastructure.

## Current Public Activity

The organization profile indexes all 3 public biotec-line repositories, verified against GitHub metadata on **2026-09-23**. The organization holds exactly 3 repositories in total, so the public directory below is complete by construction — there is no unlisted public repository.

| Repository | Latest public push | Public focus |
|---|---:|---|
| [genotype-to-vcf](https://github.com/biotec-line/genotype-to-vcf) | 2026-09-22 | DTC DNA raw-data to VCF 4.2 conversion with PySide6 GUI, headless CLI, GRCh37/GRCh38 detection, dbSNP, and FASTA reference lookup |
| [VFDistiller](https://github.com/biotec-line/VFDistiller) | 2026-09-21 | Local-first VCF/gVCF annotation desktop app; accessibility & keyboard navigation, multi-layer app icons, gnomAD/ClinVar-oriented fields, FASTA validation, and research exports |
| [.github](https://github.com/biotec-line/.github) | 2026-09-20 | Public organization start page, shared community-health defaults, and machine-readable `llms.txt` discovery context |
...
```mermaid
graph TD
    Input["DTC DNA Raw Data<br/><i>23andMe, MyHeritage, FTDNA, TellMeGen</i>"] --> G2V["genotype-to-vcf"]
...
| Need | Start with | Why |
|---|---|---|
| Convert 23andMe, MyHeritage, FTDNA, TellMeGen, or similar raw DNA exports to VCF 4.2 | [genotype-to-vcf](https://github.com/biotec-line/genotype-to-vcf) | PySide6 desktop converter and headless CLI with GRCh37/GRCh38 detection, dbSNP/FASTA reference lookup, SHA256 release verification, local cache, and privacy-focused VCF output. Runs on Windows, macOS, and Linux. |
...
This directory lists all 3 public repositories that are part of the biotec-line organization profile as verified on **2026-09-23**. Private, internal, or unreleased research work is intentionally not listed here.
...
<p align="center"><a href="https://github.com/biotec-line/genotype-to-vcf"><img src="https://raw.githubusercontent.com/biotec-line/genotype-to-vcf/master/assets/banner.svg" alt="genotype-to-vcf" width="680" style="border:2px solid #3b82f6;border-radius:8px;display:block;margin:0 auto"></a><a href="https://github.com/biotec-line/VFDistiller"><img src="https://raw.githubusercontent.com/biotec-line/VFDistiller/main/assets/banner.svg" alt="VFDistiller" width="680" style="border:2px solid #34d399;border-radius:8px;display:block;margin:0 auto"></a></p>
...
Useful GitHub and web search phrases include `biotec-line VCF tools`, `DTC DNA to VCF converter`, `23andMe MyHeritage FTDNA TellMeGen VCF conversion`, `local-first VCF annotation desktop app`, `genotype-to-vcf CLI headless pipeline`, `gVCF filtering GUI`, `gnomAD ClinVar FASTA variant review`, `research-use-only genetic variant annotation software`, `offline bioinformatics desktop tools`, `privacy-first genomic data conversion`, `GRCh37 GRCh38 auto-detection Python`, `bioinformatics local-first open-source`, `DTC genomics local-first`, `23andMe VCF converter python`, `gnomAD offline variant filtering`, and `local FASTA reference matching`.
...
| **entertain-and-more** | Interactive games and AI tabletop tools | [entertain-and-more](https://github.com/entertain-and-more) |
